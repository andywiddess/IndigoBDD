...
{
	/// <summary>
	/// Encapsulates read-only collection.
	/// </summary>
	...
	public class ReadOnlyCollection<T>: ICollection<T>
	{
		...
		/// Internal collection.
		/// </summary>
		private readonly ICollection<T> m_Internal;
		...
		/// </summary>
		/// <param name="other">The collection to encapsulate.</param>
		...
		/// <exception cref="T:System.ArgumentException"><paramref name="array"/> is multidimensional.-or-<paramref name="arrayIndex"/> 
		/// is equal to or greater than the length of <paramref name="array"/>.-or-The number of elements in the source 
		/// <see cref="T:System.Collections.Generic.ICollection`1"/> is greater than the available space from 
		/// <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.-or-Type <typeparamref name="T"/> 
