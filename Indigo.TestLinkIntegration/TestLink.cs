...
namespace Indigo.TestLinkIntegration
{
    ...
    public class TestLink
    {
        ...
        public List<TestCaseId> GetTestCaseIDByName(string testcasename, string testsuitename)
        {
            ...
            if (errs.Count > 0 && 
                errs[0].code == 5030) // 5030 is no id found
        ...
        /// <returns>
        /// a list containing zero to many test cases with that name that occur in the specific test suite
        /// </returns>
        ...
        /// <param name="testcasename">name of the test case (case sensitive)</param>
        /// <returns>
        /// a list containing zero to many test case id objects with that name
        /// </returns>
        ...
        /// <summary>
        /// Processes the test case identifier.
        /// </summary>
        ...
        /// <returns></returns>
        public GeneralResult CreateTestCase(
                string authorLogin, int testsuiteid, string testcasename, int testprojectid,
        ...
        /// <returns></returns>
        /// <remarks>
        /// this testExternalid is a string and a concatenation of the
        ...
        public List<TestCaseFromTestPlan> GetTestCasesForTestPlan(int testplanid, int testcaseid, int buildid, int keywordid, bool executed, int assignedTo, string executedstatus)
        {
            ...
            if (response is string && 
                (string)response == string.Empty)  // equals null return
                return result;
        ...
        /// <param name="testplanid">The testplanid.</param>
        /// <returns>
        /// List of test cases with test plan data added
        /// </returns>
        ...
        /// a TestPlan or Null
        /// </returns>
        /// <exception cref="TestLinkException">Testlink returned an error (code={0}, msg= {1})</exception>
