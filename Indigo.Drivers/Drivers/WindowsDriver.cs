...
namespace Indigo.Drivers
{
        ...
        : IDriver
    {
        ...
        /// </exception>
        /// <exception cref="System.Exception">The Test configuration matching your given statement has failed
        /// or</exception>
        public void GetApplication(string name, string path, string outputPath, string form)
        {
            ...
            {
                throw new Exception("The given statement is incorrectly formattted");
            }
        }
        ...
        public void SetFeature(string feature, string dataSet)
        {
            ...
            {
                dataList = ExcelUtils
                    .Get(System.Configuration.ConfigurationManager.AppSettings[Resource.FEATURE_DATA_TO_USE])
        ...
        public bool CheckButtonIsDisabled(string buttonName)
        {
            ...
            var button = Utils.FindButton(MainWindow, buttonName);
        ...
        {
            throw new NotImplementedException("FillOutPanelHtmlValue Not Implemented");
        }
        ...
        /// <exception cref="NotImplementedException">FillOutFilterValue Not Implemented</exception>
        /// <exception cref="Exception"></exception>
        public void FillOutFilterValue(string text, int filterColumn)
        {
            throw new NotImplementedException("FillOutFilterValue Not Implemented");
        }
        ...
        {
            throw new NotImplementedException("SetRadioButton not Implemented");
        }
        ...
        public void CheckFieldHasValue(string text, string label)
        {
            ...
            if (!labelField.Name.Equals(text))
                throw new Exception($"Unable to find the value {text} in label {label}");
        }
        ...
        /// <exception cref="NotImplementedException">NavigateToPage</exception>
        public void NavigateToPage(string location)
        {
            LogUtils.LogStart(() => location);

            throw new NotImplementedException("NavigateToPage");
        }
        ...
        public bool UrlContains(string location)
        {
            ...
            throw new NotImplementedException("UrlContains  Not Implemented");
        }
        ...
        public bool UrlDoesNotContain(string location)
        {
            ...
            throw new NotImplementedException("UrlDoesNotContain Not Implemented");
        }
        ...
        {
            LogUtils.LogStart(() => option, () => element);

            throw new NotImplementedException("SelectOptionFromDDL Not Implemented");
        }
        ...
        public bool CheckItemIsNotVisible(string item)
        {
            ...
            throw new NotImplementedException("CheckItemIsNotVisible Not Implemented");
        }
        ...
        /// <exception cref="NotImplementedException">ChangeColourwheelColour Not Implemented</exception>
        public void ChangeColourwheelColour(int x, int y, string colour)
        {
            LogUtils.LogStart(() => x, () => y, () => colour);

            throw new NotImplementedException("ChangeColourwheelColour Not Implemented");
        }
        #endregion
